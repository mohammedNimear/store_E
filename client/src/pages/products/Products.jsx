...
const Products = () => {
  ...
  return (
    <div className="products">
      ...
      <div className="right">
        <img
          src="https://images.unsplash.com/photo-1679163096312-4edfbfbe2a73?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHw0M3x8fGVufDB8fHx8&auto=format&fit=crop&w=400&q=60"
          alt="category_image"
          className="catImg"
        />
